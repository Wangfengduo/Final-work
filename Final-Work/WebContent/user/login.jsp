...
<div class="content inside-page login">
        <h2 class="title">登陆/注册</h2>
        		<div class="breadcrumb"><a href="index.jsp">主页</a> / 结账</div>

		<div class="row">
			<div class="col-sm-6">
				<h3>登陆</h3>
				
				<form action="${ctx}/user/login" name="login" id="login-form" method="post">
	 
				<div class="form-group">
					<label for="exampleInputEmail1">账户</label>
					<input  type="text" class="form-control" id="exampleInputEmail1" placeholder="Username" id="loginName" name="loginName"/>
				</div>
