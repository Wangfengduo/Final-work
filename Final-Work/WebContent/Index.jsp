...
<div class="hero-land clearfix">
        ...
        <div class="caption animated fadeInUp"><h1>女士商品</h1><a href="collections.jsp"><i class="fa fa-angle-right"></i></a></div>
        </div>
        <div class="landing women-land">
        <img src="images/male.jpg"  class="img-responsive" alt="slide">
        <div class="caption  animated fadeInUp"><h1>男士商品</h1><a href="collections.jsp"><i class="fa fa-angle-right"></i></a></div>
        </div>
</div>
<!-- hero landing -->
