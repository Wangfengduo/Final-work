  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr class="bggray" onMouseOut="this.style.backgroundColor='#f9f9f9'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderbottom"> <a href="showOrder.action?orderId=${order.orderId}">详情</a><span class="gray">&nbsp;|&nbsp;</span><a href="deleteOrder.action?orderId=${order.orderId}">删除</a></td>
      </tr>
    </table> 
    </td>
 </tr>
    <tr>
       <td width="90%" colspan="6" valign="middle">
         <form method="post" action="orderlist.action">
