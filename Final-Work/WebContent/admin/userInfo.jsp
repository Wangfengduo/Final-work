...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr class="bggray" onMouseOut="this.style.backgroundColor='#f9f9f9'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom">${user.email }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${user.telephone }</td>
        <td align="center" valign="middle" class="borderright borderbottom">${user.address }</td>
        <td align="center" valign="middle" class="borderright borderbottom"><a href="deleteUser.action?username=${user.username }">删除</a></td>
      </tr>
      </c:forEach>
    </table></td>
    </tr>
  ...
  <tr>
    <td colspan="6" align="center" >共${page.totalRecords}条记录 共${page.totalPages}页 当前第${page.pageNo}页<br><br>
        ...
        <a href="userInfo.action?pageNo=${page.topPageNo }"><input type="button" name="fristPage" value="首页" /></a>
        <c:choose>
          <c:when test="${page.pageNo!=1}">
            
              <a href="userInfo.action?pageNo=${page.previousPageNo }"><input type="button" name="previousPage" value="上一页" /></a>
        ...
        <c:choose>
          <c:when test="${page.pageNo != page.totalPages}">
            <a href="userInfo.action?pageNo=${page.nextPageNo }"><input type="button" name="nextPage" value="下一页" /></a>
          </c:when>
          <c:otherwise>
        ...
        <a href="userInfo.action?pageNo=${page.bottomPageNo }"><input type="button" name="lastPage" value="尾页" /></a>
    </td>
    </tr>
</table>
</body>
